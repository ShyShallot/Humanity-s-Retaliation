...
function Definitions()
    ...
    hero_alive_table = {
        ["UNSC_POA"] = false,
        ["UNSC_IAC"] = false,
        ["UNSC_ROMAN_BLUE"] = false,
        ["UNSC_SOF"] = false,
        ["UNSC_INFINITY"] = false
    }

    hero_name_table = {
        ["UNSC_POA"] = "The Pillar of Autumn",
        ["UNSC_IAC"] = " The In Amber Clad",
        ["UNSC_ROMAN_BLUE"] = "Fleet Admiral Hood",
        ["UNSC_SOF"] = "The Spirit Of Fire",
        ["UNSC_INFINITY"] = "The Infinity"
    }
